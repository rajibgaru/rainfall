...
export async function POST(
  ...
  try {
    // Extract the auction ID from params - Note: We are NOT using params.id directly anymore
    const { id } = params;
    ...
    const auctionId = id; // Use the extracted id
...
export async function DELETE(
  ...
  try {
    // Extract the auction ID from params
    const { id } = params;
